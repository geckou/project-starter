...
const MANUAL_STEPS = [
  ...
  'Template Sync（.github/workflows/template-sync.yml）の認証を設定し、template-sync ラベルを作る。GitHub App（Variables: TEMPLATE_SYNC_APP_CLIENT_ID / Secrets: TEMPLATE_SYNC_APP_PRIVATE_KEY）推奨、PAT なら Secrets: TEMPLATE_SYNC_TOKEN（→ .claude/docs/git-workflow.md「Template Sync の有効化」）',
